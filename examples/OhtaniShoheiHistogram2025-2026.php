...
$dailyData = $csvUtil->getDailyData(__DIR__ . '/csv/ohtani_shohei_2025-2026.csv');
...
foreach ($dailyData as $key => $data) {
    echo "\n## " . $key . "\n\n";
    $filename = 'HistogramOhtaniShohei' . $key . '.png';
    $histogramPath = __DIR__ . '/img/' . $filename;
    $hg->setData($data)
    ...
    echo "</details>\n\n";
    echo "\n\n";
    echo "![Histogram:" . $key . "](img/" . $filename . ")";
    echo "\n\n";
}
